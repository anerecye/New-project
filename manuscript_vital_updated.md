...
**Conclusion:** Severe annotation alone is not sufficient to override population-frequency contradiction. VITAL turns hidden frequency-assertion tension into a short, explainable laboratory review queue while preserving gray no-frequency-evidence states and leaving final classification to expert clinical interpretation.
...
The central biological claim is that severe annotation is not a shield against population-frequency contradiction. Among 334 AF-observed arrhythmia P/LP variants, 115 (34.4%) had popmax/global AF >1e-5. This was not confined to benign-looking missense assertions: 92/262 LOF/splice records (35.1%) were frequency-discordant, similar to missense records (19/66, 28.8%; Fisher OR=1.34, p=0.384). Within LOF subtypes, frequency discordance was present in 29/82 frameshift variants (35.4%), 33/108 stop-gained variants (30.6%), and 23/60 canonical splice variants (38.3%). Severe HGVS consequence therefore does not make a ClinVar P/LP assertion frequency-clean.

This pattern was systematic rather than a single-gene artifact. Severe-annotation discordance spanned 10 arrhythmia genes. After excluding CASQ2 and TRDN, the recessive/biallelic arrhythmia genes most likely to tolerate carrier frequency, 57/197 severe annotations (28.9%) remained frequency-discordant across 8 genes. Restricting to constrained genes did not eliminate the pattern: among genes with gnomAD LOEUF upper confidence bound <0.5, 24/76 severe annotations (31.6%) remained frequency-discordant. The result is not that LOF variants are often benign. The narrower and more clinically useful conclusion is that LOF annotations are not sufficient to override population-frequency contradictions. When severe annotation, public P/LP assertion, and population frequency disagree, the correct review target is mechanism and effect size: recessive carrier state, founder enrichment, reduced penetrance, hypomorphic effect, transcript rescue or NMD escape, allele-specific evidence, or overcalling.
...
This is the problem VITAL operationalizes. Global AF detected only 13 arrhythmia variants above 1e-5, whereas popmax/global screening detected 115, and nearly one-third of variants with complete popmax data were globally rare but population-enriched. At the same time, more than 80% of variants lacked usable exact AF evidence, and indels/duplications were disproportionately affected. Frequency workflows therefore fail in two directions: they miss ancestry-specific frequency contradictions and they can overinterpret absence for poorly represented variant classes.
