...
The central finding is not that ClinVar P/LP variants are usually rare; that is expected. The stronger biological claim is that clinical genomics cannot treat severe annotation as a shield against population evidence. Frequency discordance was not a missense-only phenomenon: it appeared systematically among frameshift, stop-gained, and splice-labeled P/LP assertions across multiple genes, persisted after excluding canonical recessive arrhythmia genes, and remained visible in externally constrained genes. LOF annotations are therefore not sufficient to override population-frequency contradictions; they identify a mechanism hypothesis that still has to be reconciled with ancestry, AC, penetrance, inheritance mode, transcript context, and review strength. This is the misinterpretation hazard: a severe-looking ClinVar P/LP assertion can be both mechanistically plausible and too frequent for the high-penetrance label attached to it.
...
- Supplementary Table S22: severe-annotation frequency discordance and expert-panel comparator, including LOF subtype summaries, recessive-gene exclusion, constrained-gene checks, and curated high-tension examples.
