...
This is the problem VITAL operationalizes. Global AF detected only 13 arrhythmia variants above 1e-5, whereas popmax/global screening detected 115, meaning global-AF-only review missed 102/115 ancestry-aware frequency alerts. At the same time, more than 80% of variants lacked usable exact AF evidence, and indels/duplications were disproportionately affected. Frequency workflows therefore fail in two directions: they miss ancestry-specific frequency contradictions and they can overinterpret absence for poorly represented variant classes. This is a guideline implementation gap, not a critique of frequency criteria themselves: BS1/BA1-style reasoning cannot work as intended if the workflow hides popmax tension or treats non-observation as rarity.
