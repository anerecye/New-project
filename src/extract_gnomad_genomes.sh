...
OUT_DIR="data/processed/gnomad_genomes_by_chr"
BED_DIR="data/processed/bed_by_chr"
OUT_FILE="data/processed/gnomad_genomes_subset_with_header.tsv"
...
for chrom in "${CHROMS[@]}"; do
  ...
  bcftools query \
    ...
    "https://storage.googleapis.com/gcp-public-data--gnomad/release/4.1.1/vcf/genomes/gnomad.genomes.v4.1.1.sites.chr${chrom}.vcf.bgz" \
